    ...
    public function run(): void
    {
        $types = [
            ...
            [
                'name' => 'Prekursor',
                'code' => 'prekursor',
                'description' => 'Obat golongan prekursor farmasi dengan pengawasan khusus',
                'requires_prescription' => true,
                'is_narcotic' => false,
                'color' => '#a855f7',
                'sort_order' => 6,
            ...
            [
                'name' => 'Obat-Obatan Tertentu (OOT)',
                'code' => 'oot',
                'description' => 'Obat-obatan tertentu yang berpotensi disalahgunakan',
                'requires_prescription' => true,
                'is_narcotic' => false,
                'color' => '#f97316',
                'sort_order' => 7,
