            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="text-white">
                    <div class="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm mb-6">
                        ...
                        Solusi Digital untuk Operasional Apotek
                    </div>
                    ...
                    <p class="text-lg sm:text-xl text-teal-100 mb-8 leading-relaxed">
                        Kelola apotek Anda dengan fitur yang lengkap. Tersedia untuk Phone dan Tablet dengan fitur Kasir, Manajemen Stok, Laporan, dan masih banyak lagi.
                    </p>
                    ...
                    <div class="mt-10 flex items-center gap-6 text-sm text-teal-200">
                        <div class="flex items-center gap-2">
                            ...
                            Data & transaksi tercatat rapi
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                            </svg>
                            Stabil & Mudah Digunakan
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl bg-black aspect-video">
                    <iframe
                        ...
                        src="https://www.youtube.com/embed/NqDlSCYlxus"
                ...
                <div class="mt-8 flex flex-wrap justify-center gap-4">
                    <a href="https://youtu.be/NqDlSCYlxus" target="_blank" class="inline-flex items-center gap-2 bg-red-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-red-700 transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                        </svg>
                        Tonton di YouTube
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-br from-teal-600 to-teal-800 rounded-3xl p-8 sm:p-12 lg:p-16 text-white text-center">
                ...
                <p class="text-lg text-teal-100 mb-8 max-w-2xl mx-auto">
                    Login ke dashboard admin untuk kelola produk, stok, kategori, supplier dan lihat laporan lengkap.
                </p>
        ...
        <section id="pricing" class="py-20 lg:py-28 bg-gray-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Solusi Digital untuk Apotek yang Ingin Naik Kelas</h2>
                    <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                        Satu sistem untuk penjualan, manajemen stok, dan laporan apotek. Dibangun untuk kebutuhan UMKM apotek di Indonesia.
                    </p>
                </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-lg text-gray-300 mb-8">
                        Ada pertanyaan tentang Apotek POS ? Hubungi kami melalui WhatsApp.
                    </p>
                    <div class="space-y-4">
                        <a href="https://wa.me/6285377745621" target="_blank" class="flex items-center gap-4 bg-green-600 hover:bg-green-700 text-white px-6 py-4 rounded-xl transition-colors">
                ...
                <div class="bg-gray-800 rounded-2xl p-8">
                    <h3 class="text-xl font-semibold mb-6">Tentang Kami</h3>
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-semibold text-white">Layanan & Dukungan</h4>
                                <p class="text-gray-400">Full Support • Lifetime Maintenance</p>
                            </div>
                        </div>
                    </div>
                </div>
